...
--
-- Name: email_tpl; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.email_tpl (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
...
--
-- Name: email_tpl_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.email_tpl ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.email_tpl_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
334	99	system:admin:emailTpls	system:admin:emailTpls
\.
...
1034	system	locale	{"phone":{"mask":null,"placeholder":"+1(555)123-4567"},"money":{"decimal":".","thousand":",","precision":2,"format":"%v %s","symbol":"$"},"date":{"dateShort":"MM/dd/yy","dateMedium":"dd-MMM-yyyy","dateLong":"MMMM d, yyyy","dateTimeShort":"MM/dd/yy HH:mm","dateTimeMedium":"dd-MMM-yyyy HH:mm","dateTimeLong":"MMMM d, yyyy HH:mm","time":"HH:mm"}}
\.
...
SELECT pg_catalog.setval('public.auth_resource_resource_id_seq', 334, true);
...
SELECT pg_catalog.setval('public.auth_rule_rule_id_seq', 121, true);
...
--
-- Name: email_tpl_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.email_tpl_id_seq', 3, true);
...
--
-- Name: email_tpl email_tpl_alias_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_tpl
    ADD CONSTRAINT email_tpl_alias_key UNIQUE (alias);


--
-- Name: email_tpl email_tpl_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_tpl
    ADD CONSTRAINT email_tpl_pkey PRIMARY KEY (id);
...
--
-- Name: person_site_id_email_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX person_site_id_email_idx ON public.person USING btree (site_id, email) WHERE (registered_at IS NOT NULL);
